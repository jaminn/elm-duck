                    ...
                    ( { model
                        | world =
                            ...
                            model.world
                                |> Physics.World.add
                                    (body
                                        |> Physics.Body.rotateAround Axis3d.x (Angle.degrees 0)
                                        |> Physics.Body.moveTo (Point3d.meters 1 1 6)
                                    )
                                |> Physics.World.add
                                    (body
                                        |> Physics.Body.rotateAround Axis3d.x (Angle.degrees 0)
                                ...
                                |> Physics.World.add
                                    (body
                                        |> Physics.Body.rotateAround Axis3d.x (Angle.degrees 100)
                                        |> Physics.Body.moveTo (Point3d.meters 0 0 8)
                                    )
                                |> Physics.World.add
                                    (body
                                        |> Physics.Body.rotateAround Axis3d.x (Angle.degrees 0)
                                        |> Physics.Body.moveTo (Point3d.meters 2 0 9)
                                    )
                                |> Physics.World.add
                                    (body
                                        |> Physics.Body.rotateAround Axis3d.x (Angle.degrees 0)
                                        |> Physics.Body.moveTo (Point3d.meters 2 0 10)
                                    )
                                |> Physics.World.add
                                    (body
                                        |> Physics.Body.rotateAround Axis3d.x (Angle.degrees 0)
                                        |> Physics.Body.moveTo (Point3d.meters 2 0 12)
                                    )
                      }
                    , Cmd.none
                    )
